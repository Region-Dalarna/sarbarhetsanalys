...
bef_avesta <- format(plyr::round_any(befolkning_df %>% filter(region == "Avesta") %>% .$Antal,50),big.mark=" ")
bef_borlänge <- format(plyr::round_any(befolkning_df %>% filter(region == "Borlänge") %>% .$Antal,50),big.mark=" ")
bef_falun <- format(plyr::round_any(befolkning_df %>% filter(region == "Falun") %>% .$Antal,50),big.mark=" ")
bef_gagnef <- format(plyr::round_any(befolkning_df %>% filter(region == "Gagnef") %>% .$Antal,50),big.mark=" ")
bef_hedemora <- format(plyr::round_any(befolkning_df %>% filter(region == "Hedemora") %>% .$Antal,50),big.mark=" ")
bef_leksand <- format(plyr::round_any(befolkning_df %>% filter(region == "Leksand") %>% .$Antal,50),big.mark=" ")
bef_ludvika <- format(plyr::round_any(befolkning_df %>% filter(region == "Ludvika") %>% .$Antal,50),big.mark=" ")
bef_malung_salen <- format(plyr::round_any(befolkning_df %>% filter(region == "Malung-Sälen") %>% .$Antal,50),big.mark=" ")
bef_mora <- format(plyr::round_any(befolkning_df %>% filter(region == "Mora") %>% .$Antal,50),big.mark=" ")
bef_orsa <- format(plyr::round_any(befolkning_df %>% filter(region == "Orsa") %>% .$Antal,50),big.mark=" ")
bef_rattvik <- format(plyr::round_any(befolkning_df %>% filter(region == "Rättvik") %>% .$Antal,50),big.mark=" ")
bef_smedjebacken <- format(plyr::round_any(befolkning_df %>% filter(region == "Smedjebacken") %>% .$Antal,50),big.mark=" ")
bef_sater <- format(plyr::round_any(befolkning_df %>% filter(region == "Säter") %>% .$Antal,50),big.mark=" ")
