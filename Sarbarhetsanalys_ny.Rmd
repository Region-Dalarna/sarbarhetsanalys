...
En indikator är antalet privata arbetsställen (med minst 1 anställd), och i Dalarna finns det något fler sådana i jämförelse med i Sverige. I Dalarna fanns `r max(arbetsstallen_df$year)` ungefär `r round(arbetsstallen_df %>% filter(Kommun == "Dalarna") %>% .$Arb_stallen,0)` privata arbetsställen per 1000 invånare, att jämföra med drygt `r round(arbetsstallen_df %>% filter(Kommun == "Riket") %>% .$Arb_stallen,0)` i Sverige. Bland Dalarnas kommuner är variationen stor, där `r arbetsstallen_df %>% filter(Arb_stallen == max(Arb_stallen)) %>% .$Kommun`  har klart flest med `r round(arbetsstallen_df %>% filter(Arb_stallen == max(Arb_stallen)) %>% .$Arb_stallen,0)` per 1000 invånare, medan Smedjebacken och Ludvika återfinns på andra sidan spektrumet med ungefär hälften så många privata arbetsställen per 1 000 invånare.
<br>
<br>
```{r, include = FALSE}
    # Används i de tre nästkommande diagrammen (alla kopplade till företagarna)
    diagram_capt <- c("Källa: SCB.\nBearbetning: Samhällsanalys, Region Dalarna.\nDiagramförklaring: Gäller arbetsställen med minst 1 anställd")

    diagramtitel <- paste0("Antal privata arbetsställen per 1000 invånare år ",max(arbetsstallen_df$year))
    diagramfilnamn <- paste0("arbetsstallen_per_1000.png")
    
    arbetsstallen_fig <- SkapaStapelDiagram(skickad_df = arbetsstallen_df %>% 
                                   mutate(Kommun = ifelse(Kommun == "Riket", "Sverige",Kommun),
                                          fokus = ifelse(Kommun == "Riket",1,
                                                         ifelse(Kommun == "Dalarna",2,0))),
...
En äldre befolkning kan naturligtvis få ett flertal följder för en kommun på längre sikt genom äldres potentiella behov av vård och omsorg. Ett sätt att mäta detta är genom den så kallade demografiska försörjningskvoten (se `r paste0("figur ",i+2)`). Den beräknas genom att relatera antalet personer i arbetsför ålder, de som är mellan 20 och 64 år, till unga (0-19 år) och äldre (>64år). Normalt är den kommunala kostnaden relativt låg för personer i arbetsför ålder, medan den är avsevärt högre för unga (kostnad för förskola och skola) och äldre (äldreomsorg mm). Det är därför intressant att relatera dessa grupper till personer i arbetsför ålder. I Dalarna är den demografiska försörjningskvoten högst i Rättvik, där grupperna unga och äldre sammantaget är större än gruppen i arbetsför ålder (en försörjningskvot som överstiger 100). Försörjningskvoten ökar dessutom i samtliga Dalarnas kommuner över tid, vilket är i linje med en allt äldre befolkning.
<br>
<br>
```{r, echo=FALSE, fig.width=10, fig.align='Left'}
...
Andelen av befolkningen (25-64 år) med minst 3 års eftergymnasial utbildning (fortsättningsvis högre utbildning) var 2021 relativt låg i Dalarnas kommuner (se `r paste0("figur ",i+1)`). Bland länets 15 kommuner var det bara Falun som hade en högre utbildningsnivå än Sverige som helhet. Detta beror sannolikt på att Falu lasarett, där många har högre utbildning, är en av stadens största arbetsgivare. Utbildningsnivån i övriga kommuner är avsevärt mycket lägre och i exempelvis Vansbro är andelen med högre utbildning mindre än hälften av andelen med högre utbildning i Falun och Sverige. Dalarna tillhör Sveriges lägst utbildade län, där drygt 21 procent av befolkningen har en högre utbildning, att jämföra med Sverige där ungefär 30 procent av befolkningen (25-64 år) har en högre utbilning. Det är dock viktigt att notera att utbildningsnivån anpassar sig efter efterfrågan i kommunen eller regionen. Om Vansbros arbetsgivare efterfrågar arbetskraft med framförallt gymnasial bakgrund är det orimligt om kommunen har samma genomsnittliga utbildningsnivå som Falun. Matchningen mellan arbetsgivare och arbetstagare skulle helt enkelt bli för dålig. 
<br>
<br>
```{r, echo=FALSE, fig.width=10, fig.align='Left'}
...
Den största arbetsgivaren i Avesta var år 2021 Avesta kommun med strax över 2000 anställda. Bland privata arbetsgivare hade Outokumpu Stainless flest anställda med ca 850. Även Stora Enso och Region Dalarna är stora arbetsgivare i Avesta
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Avesta_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
</p>
...
Den största arbetsgivaren i Borlänge var år 2021 Borlänge kommun med runt 5 500 anställda. Bland privata arbetsgivare hade SSAB flest anställda med ca 1 600. Även Trafikverket är en viktig arbetsgivare med ungefär 1 500 anställda på sitt huvudkontor i Borlänge.
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Borlänge_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
...
De två klart största arbetsgivarna i Falun år 2021 var Region Dalarna och Falu kommun, som tillsammans hade fler än 9 000 anställda. Bland privata arbetsgivare var Libra assistans störst, med strax under 500 anställda.
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Falun_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
...
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Gagnef_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
...
Den största arbetsgivaren i Hedemora var år 2021 Hedemora kommun med drygt 1 500 anställda. Bland privata arbetsgivare hade Boliden mineral flest anställda med nästan 500 anställda. I övrigt finns ett antal arbetsgivare med mellan 100 och 300 anställda.
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Hedemora_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
...
Den största arbetsgivaren i Leksands var år 2021 Leksands kommun med drygt 1 800 anställda. Bland privata arbetsgivare är Clas Ohlson, med säte i Insjön, klart störst med nästan 1 000 anställda.
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Leksand_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
...
Den största arbetsgivaren i Ludvika var år 2021 Hitachi med drygt 2 700 anställda. Nästan lika många anställda hade Ludvika kommun. Bland andra stora arbetsgivare finns Spendrups och Region Dalarna, med strax över 500 anställda vardera.
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Ludvika_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
...
Ludvika har både lägst antal arbetställen och lägst antal nystartade företag i Dalarna (per 1000 invånare), samtidigt som konkurserna ligger runt genomsnittet. Positivt är dock att antalet nystartade företag har ökat stadigt sedan slutet av 00-talet.
...
Den största arbetsgivaren i Malung-Sälen var år 2021 Malung-Sälens kommun med nästan 1 000 anställda. Skistar är den största privata arbetsgivaren med strax över 500 anställda.  
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Malung-Sälen_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
...
Den största arbetsgivaren i Mora var år 2021 Mora kommun med drygt 1 800 anställda. Många i Mora jobbar även för Region Dalarna, medan FM Mattsson är den största privata arbetsgivaren med drygt 300 anställda.
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Mora_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
...
Den största arbetsgivaren i Orsa var år 2021 Orsa kommun med drygt 620 anställda. Bland privata arbetsgivare hade Transdev, som under 2021 köpte Siljans buss, flest anställda med drygt 220.
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Orsa_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetgivare")`
</p>
...
Den klart största arbetsgivaren i Rättvik var år 2021 Rättviks kommun med drygt 1 200 anställda. Bland övriga arbetsgivare är de flesta avsevärt mindre. 
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Rättvik_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
...
Den största arbetsgivaren i Smedjebacken var år 2021 Smedjebackens kommun med närmare 1 100 antsällda. Bland privata arbetsgivare var Ovako störst, med drygt 350 anställda.
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Smedjebacken_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
...
Den största arbetsgivaren i Säter var år 2021 Säters kommun med närmare 1 250 antsällda. Även Region Dalarna är en stor arbetsgivare, medan det inom det privata näringslivet bara finns ett företag med mer än 50 anställda (Gustafs Scandinavia).
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Säter_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
...
Den största arbetsgivaren i Vansbro var år 2021 Vansbro kommun med närmare 900 anställda. Inom det privata arbetslivet jobbade flest, drygt 350 fördelat på två företag, på Lyko.
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Vansbro_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
...
Den största arbetsgivaren i Älvdalen var år 2021 Älvdalens kommun med närmare 800 anställda. Inom det privata närngslivet hade Idre Fjäll flest anställda, med strax över 200.
<br>
<br>
```{r, echo=FALSE, fig.width=8, fig.align='Left'}
knitr::include_graphics(here("Diagram","Storsta_arbetsgivare_Älvdalen_2021.png"))
i=i+1
```
<p style="font-size:9pt; font-style:italic">
    `r paste0("Figur ",i," : Största arbetsgivare")`
